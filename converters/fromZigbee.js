  ...
  moesS_thermostat: {
    ...
    convert: (model, msg, publish, options, meta) => {
      ...
      switch (dp) {
        ...
        default:
          meta.logger.warn(`zigbee-herdsman-converters:moesS_thermostat: NOT RECOGNIZED DP #${dp} with data ${JSON.stringify(dpValue)}`);
      }
    },
  },
  tvtwo_thermostat: {
    ...
    convert: (model, msg, publish, options, meta) => {
      ...
      switch (dp) {
        ...
        default:
          meta.logger.warn(`zigbee-herdsman-converters:tvtwo_thermostat: NOT RECOGNIZED DP #${dp} with data ${JSON.stringify(dpValue)}`);
      }
    },
  },
  haozee_thermostat: {
