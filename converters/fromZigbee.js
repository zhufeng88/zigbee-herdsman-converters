...
const converters = {
    ...
    moes_switch: {
        ...
        convert: (model, msg, publish, options, meta) => {
            ...
            default:
                meta.logger.warn(`fromZigbee:moes_switch: NOT RECOGNIZED DP #${dp} with data ${JSON.stringify(dpValue)}`);
                break;
            }
        },
    },
    ...
    moesS_thermostat: {
        ...
        convert: (model, msg, publish, options, meta) => {
            ...
            default:
                meta.logger.warn(`zigbee-herdsman-converters:moesS_thermostat: NOT RECOGNIZED DP #${dp} 
    ...
    tvtwo_thermostat: {
        ...
        convert: (model, msg, publish, options, meta) => {
            ...
            default:
                meta.logger.warn(`zigbee-herdsman-converters:tvtwo_thermostat: NOT RECOGNIZED DP #${dp}
                    with data ${JSON.stringify(dpValue)}`);
            }
        },
    },
    haozee_thermostat: {
        ...
        convert: (model, msg, publish, options, meta) => {
            ...
            case tuya.dataPoints.haozeeSoftVersion:
                ...
                break;
            default:
                meta.logger.warn(`zigbee-herdsman-converters:haozee: NOT RECOGNIZED DP #${dp} with data ${JSON.stringify(dpValue)}`);
            }
        },
    },
    tuya_air_quality: {
    ...
    saswell_thermostat: {
        ...
        convert: (model, msg, publish, options, meta) => {
            ...
            default:
                meta.logger.warn(`zigbee-herdsman-converters:SaswellThermostat: Unrecognized DP #${dp} 
                    with data ${JSON.stringify(dpValue)}`);
            }
        },
    },
    ...
    ZB003X: {
        ...
        convert: (model, msg, publish, options, meta) => {
            ...
            default:
                meta.logger.warn(`zigbee-herdsman-converters:FantemZB003X: Unrecognized DP #${dp} with data ${JSON.stringify(dpValue)}`);
            }
        },
    },
    ZB003X_attr: {
    ...
    tuya_gas: {
        ...
        convert: (model, msg, publish, options, meta) => {
            ...
            default:
                meta.logger.warn(`zigbee-herdsman-converters:tuya_gas: Unrecognized DP #${dp} with data ${JSON.stringify(dpValue)}`);
            }
        },
    },
    woox_R7060: {
    ...
    idlock: {
        ...
        convert: (model, msg, publish, options, meta) => {
            ...
            if (0x4003 in msg.data) {
                const lookup = {
                    0: 'deactivated', 1: 'random_pin_1x_use', 5: 'random_pin_1x_use', 6: 'random_pin_24_hours',
    ...
    zm25tq_cover: {
        ...
        convert: (model, msg, publish, options, meta) => {
            ...
            const dp = dpValue.dp;
            const value = tuya.getDataValue(dpValue);
            let motorDirectionValue = 'forward';
            let coverTopLimit = 103;
            let coverMiddleLimit = 104;
            let coverBottomLimit = 105;
            if (meta.state !== undefined && meta.state.motor_direction !== undefined) {
                motorDirectionValue = meta.state.motor_direction.toLowerCase();
            }
            if (motorDirectionValue !== 'forward') {
                coverTopLimit = 105;
