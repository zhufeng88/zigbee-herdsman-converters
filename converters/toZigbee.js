...
const converters = {
        ...
        convertSet: async (entity, key, value, meta) => {
            ...
            case 'alarm_humidity_min': {
                ...
                const keyToAttributeLookup = {
                    'alarm_temperature_max': 0xD00A, 'alarm_temperature_min': 0xD00B,
    ...
    zm25tq_cover_options: {
        ...
        convertSet: async (entity, key, value, meta) => {
            value = value.toLowerCase();
            const message = meta.message;
            const motorDirectionValue = message.hasOwnProperty('motor_direction') ? message.motor_direction.toLowerCase() : null;
            let coverTopLimit = 105;
            let coverMiddleLimit = 104;
            let coverBottomLimit = 103;
            // motor_direction_value is different Limit is different
